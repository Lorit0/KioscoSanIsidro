...
const reviewFilters =
    document.getElementsByClassName("filter-review") /*LISTA DE REVIEWS*/
const categoryFilters =
    document.getElementsByClassName("filter-category") /* LISTA DE CATEGORIAS*/
...
const obtenerPlantillaProductoAgregado = (id, nombre, precio, imagen) => {
    ...
    <div class="cart-product-details">
      ...
      <div class="cart-product-price-qty">
        ...
        <p class="cart-product-price">x Bs${precio}</p>
      </div>
    </div>
  </article>`
}
...
getTotal = () => {
    ...
    totalValueCalculated =
        subtotalProductsAdded +
        deliveryPrice +
        discountCalculated +
        cartTaxValueCalculated
